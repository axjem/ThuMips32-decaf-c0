...
public class MipsAsm extends Asm {
	...
	public static final String FORMAT0 = "%-8s";

	public static final String FORMAT1 = "%-8s%s";

	public static final String FORMAT2 = "%-8s%s, %s";

	public static final String FORMAT3 = "%-8s%s, %s, %s";

	public static final String FORMAT4 = "%-8s%s, %s(%s)";
